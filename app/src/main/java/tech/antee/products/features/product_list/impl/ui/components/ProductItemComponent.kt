package tech.antee.products.features.product_list.impl.ui.components
...
import tech.antee.products.features.product_list.impl.ui.items.ProductItem
...
fun ProductItemComponent(
    ...
    Row(
        ...
        Row {
            AsyncImage(
                modifier = Modifier.size(tech.antee.products.features.product_list.impl.ui.components.ProductItemComponentDefaults.IMAGE_SIZE),
                model = item.image,
            ...
            Column {
                Text(
                    modifier = Modifier.width(tech.antee.products.features.product_list.impl.ui.components.ProductItemComponentDefaults.NAME_WIDTH),
                    text = name,
