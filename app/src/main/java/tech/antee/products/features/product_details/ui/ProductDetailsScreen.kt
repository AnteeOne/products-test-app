...
import tech.antee.products.features.product_details.ui.components.BackButton
import tech.antee.products.features.product_details.ui.components.ProductImageComponent
import tech.antee.products.features.product_details.ui.components.TopAppBar
import tech.antee.products.features.product_details.ui.items.ProductDetailsEvent
...
fun ProductDetailsScreen(
    ...
    LaunchedEffect(viewModel) {
        viewModel.uiEvents.collect { event ->
            when (event) {
                ProductDetailsEvent.OnNavBack -> onNavBack()
            }
        }
    }
    with(uiState) {
