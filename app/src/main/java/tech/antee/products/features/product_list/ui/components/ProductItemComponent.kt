package tech.antee.products.features.product_list.ui.components
...
fun ProductItemComponent(
    ...
    Row(
        ...
        Row {
            AsyncImage(
                modifier = Modifier.size(tech.antee.products.features.product_list.ui.components.ProductItemComponentDefaults.IMAGE_SIZE),
                model = item.image,
            ...
            Column {
                Text(
                    modifier = Modifier.width(tech.antee.products.features.product_list.ui.components.ProductItemComponentDefaults.NAME_WIDTH),
                    text = name,
